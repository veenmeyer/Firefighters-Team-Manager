...
<?php if ($this->item) : ?>
    ...
    <div class="item_fields">
        <table class="table">
            <tr>
			<th><?php echo JText::_('COM_FIREFIGHTERS_FORM_LBL_DIENSTGRAD_ID'); ?></th>
			<td><?php echo $this->item->id; ?></td>
</tr>
<tr>
			<th><?php echo JText::_('COM_FIREFIGHTERS_FORM_LBL_DIENSTGRAD_NAME'); ?></th>
			<td><?php echo $this->item->name; ?></td>
</tr>
<tr>
			<th><?php echo JText::_('COM_FIREFIGHTERS_FORM_LBL_DIENSTGRAD_BILD'); ?></th>
			<td><?php echo $this->item->bild; ?></td>
</tr>
<tr>
			<th><?php echo JText::_('COM_FIREFIGHTERS_FORM_LBL_DIENSTGRAD_BESCHREIBUNG'); ?></th>
			<td><?php echo $this->item->beschreibung; ?></td>
</tr>
<tr>
			<th><?php echo JText::_('COM_FIREFIGHTERS_FORM_LBL_DIENSTGRAD_STATE'); ?></th>
			<td>
			<i class="icon-<?php echo ($this->item->state == 1) ? 'publish' : 'unpublish'; ?>"></i></td>
</tr>
<tr>
			<th><?php echo JText::_('COM_FIREFIGHTERS_FORM_LBL_DIENSTGRAD_CREATED_BY'); ?></th>
