...
<tr>
  ...
  <?php 
		...
		if (!$this->menu->id) {
			...
			$itemID = '&Itemid='.$this->params->get('ausbildungenlink','').'&list=1';
			endif;
		}
  echo '<a href="'.JRoute::_('index.php?option=com_firefighters&view=ausbildungen'.$itemID.'').'" class="btn"><strong>'.JText::_('Übersicht').'</strong></a></br>';
  ?>
