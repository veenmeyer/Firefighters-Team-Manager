...
<form action="<?php echo JRoute::_('index.php?option=com_firefighters&view=abteilungen'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <tr>
        ...
        <td colspan="<?php echo isset($this->items[0]) ? count(get_object_vars($this->items[0])) : 10; ?>">
			<span class="copyright">Firefighters Team Manager V<?php echo $this->version; ?>  (C) 2015 by Ralf Meyer ( <a class="copyright_link" href="https://einsatzkomponente.de" target="_blank">www.einsatzkomponente.de</a> )</span></td>
        </tr>
	<?php endif; ?>
    </tfoot>
    <tbody>
    <?php foreach ($this->items as $i => $item) : ?>
        ...
        <tr class="row<?php echo $i % 2; ?>">
				...
				<td>
				<?php if ($item->bild) : ?>
					<img class="ftm_abteilung_image" src="<?php echo JURI::Root();?><?php echo $item->bild;?>" alt="<?php echo $item->bild;?>" title="<?php echo $item->bild;?>"/>
				<?php endif;?>
