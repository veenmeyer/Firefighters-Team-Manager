...
class FirefightersViewAusbildungen extends JViewLegacy {
    ...
    public function display($tpl = null) {
		...
		if ($this->params->get('display_ausbildungen_bootstrap','0') == '1') :
		...
		if ($this->params->get('display_ausbildungen_bootstrap','0') == '2') :
		...
		$document->addStyleDeclaration($this->params->get('ausbildungen_css','')); 
