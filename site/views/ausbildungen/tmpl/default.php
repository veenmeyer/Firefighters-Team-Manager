...
$canDelete = $user->authorise('core.delete', 'com_firefighters');
		...
		if (!$this->menu->id) {
			if ($this->params->get('ausbildungenlink','')) :
			$itemID = '&Itemid='.$this->params->get('ausbildungenlink','');
			endif;
		}
?>
<!--Page Heading-->
...
<form action="<?php echo JRoute::_('index.php?option=com_firefighters&view=ausbildungen'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <?php foreach ($this->items as $i => $item) : ?>
        ...
        <tr class="row<?php echo $i % 2; ?>">
				...
				<a href="<?php echo JRoute::_('index.php?option=com_firefighters&view=ausbildung'.$itemID.'&id='.(int) $item->id); ?>">
				...
				<p><a href="<?php echo JRoute::_('index.php?option=com_firefighters&view=ausbildung'.$itemID.'&id='.(int) $item->id); ?>" class="btn btn-primary" role="button">Details</a></p>
				</td>
