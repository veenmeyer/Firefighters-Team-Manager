...
class FirefightersModelDienstgrade extends JModelList
{
    ...
    protected function populateState($ordering = null, $direction = null)
    {
		...
		$page_limit = $params->get('display_dienstgrade_pagination_limit','');
		$show_pagination = $params->get('display_dienstgrade_pagination','1');
        ...
        $limit = $app->getUserStateFromRequest('dienstgrade' . '.list', 'limit', $page_limit);
