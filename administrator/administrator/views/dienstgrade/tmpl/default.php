...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_firefighters&task=dienstgrade.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'dienstgradList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="dienstgradList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'dienstgrade.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_firefighters&task=dienstgrad.edit&id='.(int) $item->id); ?>">
