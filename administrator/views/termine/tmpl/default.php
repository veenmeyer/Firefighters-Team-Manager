...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_firefighters&task=termine.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'terminList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="terminList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FIREFIGHTERS_TERMINE_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FIREFIGHTERS_TERMINE_BILD', 'a.bild', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FIREFIGHTERS_TERMINE_EMAIL', 'a.email', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FIREFIGHTERS_TERMINE_EMAIL_GESENDET', 'a.email_gesendet', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FIREFIGHTERS_TERMINE_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'termine.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_firefighters&task=termin.edit&id='.(int) $item->id); ?>">
				...
				<td>
					<?php if (!empty($item->email)): ?>
						<?php echo '<i class="icon-publish"></i>'; ?>
					<?php else: ?>
						<?php echo '<i class="icon-unpublish"></i>'; ?>
					<?php endif; ?>				
				</td>
