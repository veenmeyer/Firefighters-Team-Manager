 ...
 */
class FirefightersViewKontrollcenters extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        FirefightersHelper::addSubmenu('kontrollcenters');
    ...
    protected function addToolbar() {
        ...
        if ($canDo->get('core.edit.state')) {
            ...
            if (isset($this->items[0]->state)) {
                ...
                JToolBarHelper::deleteList('', 'kontrollcenters.delete', 'JTOOLBAR_DELETE');
            }

            if (isset($this->items[0]->state)) {
                JToolBarHelper::divider();
                JToolBarHelper::archiveList('kontrollcenters.archive', 'JTOOLBAR_ARCHIVE');
            }
            if (isset($this->items[0]->checked_out)) {
                JToolBarHelper::custom('kontrollcenters.checkin', 'checkin.png', 'checkin_f2.png', 'JTOOLBAR_CHECKIN', true);
            }
        }
        ...
        if (isset($this->items[0]->state)) {
            if ($state->get('filter.state') == -2 && $canDo->get('core.delete')) {
                JToolBarHelper::deleteList('', 'kontrollcenters.delete', 'JTOOLBAR_EMPTY_TRASH');
                JToolBarHelper::divider();
            } else if ($canDo->get('core.edit.state')) {
                JToolBarHelper::trash('kontrollcenters.trash', 'JTOOLBAR_TRASH');
                JToolBarHelper::divider();
            }
        }
        ...
        JHtmlSidebar::setAction('index.php?option=com_firefighters&view=kontrollcenters');
