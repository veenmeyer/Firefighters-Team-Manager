...
class JFormFieldInfo extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">x</button><span aria-hidden="true" class="icon-cancel"></span>Diese Version von <b>Firefighters Team Manager</b> ist nicht validiert. Sie k&ouml;nnen selbstverst&auml;ndlich <b>alle Funktionen</b> kostenlos nutzen,<br/> aber &uuml;ber eine kleine Unterst&uuml;tzung an die Entwickler, w&uuml;rden wir uns nat&uuml;rlich sehr freuen. <br/>Helfen Sie uns, damit wir Ihnen dieses und weitere Projekte auch in Zukunft kostenlos und ohne Werbung anbieten k&ouml;nnen. <br/><br/>Schicken Sie eine Anfrage via Mail an validate@einsatzkomponente.de und holen Sie sich heute noch den Validation-Schl&uuml;ssel.<br/><br/><p>kleiner Vorteil:<br/>- Das Copyright im Frontend wird dadurch entfernt.  ;-)<br/>- und bevorzugten Support im Forum und via Email</p></div><a target="_blank" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=9HDFKVJSKSEFY"><div>Spende &uuml;ber PAYPAL : <img border=0  src="https://www.paypalobjects.com/de_DE/DE/i/btn/btn_donateCC_LG.gif" /></div></a><br/><br/>
';		
		...
		$html[] = '<h2>Firefighters Team Manager Version 1.x</h2>';
		if ($val=='12') :	$html[] = '';
		else:
