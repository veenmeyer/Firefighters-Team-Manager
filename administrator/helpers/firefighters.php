...
class FirefightersHelper {
	...
	public static function getVersion()
	{
		...
		$response = @file("https://einsatzkomponente.joomla100.com/gateway/ftm_validation.php?validation=".$params->get('validation_key','0')."&domain=".$_SERVER['SERVER_NAME']."&version=".$version->getShortVersion()."&ftmversion=".$eikoversion); // Request absetzen
